...
// https://gcore.jsdelivr.net/gh/xream/scripts@main/surge/modules/sub-store-scripts/sing-box/template.js#&type=1&name=sub&outbound=自动|手动|Github|Google|Microsoft|OpenAI|Telegram|Twitter|Youtube|国内🕳香港🏷🇭🇰|港🕳台湾🏷🇹🇼|台🕳日本🏷🇯🇵|日🕳新加坡🏷🇸🇬|新🕳美国🏷🇺🇸|美🕳其它🏷^(?!.*(?:🇭🇰|港|🇹🇼|台|🇯🇵|日|🇸🇬|新|🇺🇸|美))
// https://raw.githubusercontent.com/hellozgl/singbox_substore/refs/heads/main/substore_template.js#type=组合订阅&name=wmsxwd_com&outbound=🕳ℹ️📌 手动选择|♻️ 自动切换🏷ℹ️^(?!.*(?:官网|剩余|流量|套餐|免费|订阅|到期|文档|机场|通知|测试|Expire Date|Traffic|ExpireDate)).*🕳ℹ️🇭🇰 香港节点🏷ℹ️^(?!.*(?:us)).*(🇭🇰|HK|hk|香港|港|HongKong)🕳ℹ️🇹🇼 台湾节点🏷ℹ️^(?!.*(?:us)).*(🇹🇼|TW|tw|台湾|台|Taiwan)🕳ℹ️🇸🇬 狮城节点🏷ℹ️^(?!.*(?:us)).*(新加坡|坡|狮城|SG|Singapore)🕳ℹ️🇯🇵 日本节点🏷ℹ️^(?!.*(?:us)).*(🇯🇵|JP|jp|日本|日|Japan)🕳ℹ️🇺🇸 美国节点🏷ℹ️^(?!.*(?:AUS|RUS)).*(🇺🇸|US|us|美国|美|United States)🕳ℹ️🕸 其他节点🏷ℹ️^(?!.*(?:🇭🇰|HK|hk|香港|港|HongKong|🇹🇼|TW|tw|台湾|台|Taiwan|新加坡|坡|狮城|SG|Singapore|🇯🇵|JP|jp|日本|日|Japan|🇺🇸|US|us|美国|美|United States))

// https://raw.githubusercontent.com/xream/scripts/main/surge/modules/sub-store-scripts/sing-box/template.js#type=组合订阅&name=wmsxwd_com&outbound=🕳ℹ️📌 手动选择|♻️ 自动切换🏷ℹ️^(?!.*(?:官网|剩余|流量|套餐|免费|订阅|到期|文档|机场|通知|测试|Expire Date|Traffic|ExpireDate)).*🕳ℹ️🇭🇰 香港节点🏷ℹ️^(?!.*(?:us)).*(🇭🇰|HK|hk|香港|港|HongKong)🕳ℹ️🇹🇼 台湾节点🏷ℹ️^(?!.*(?:us)).*(🇹🇼|TW|tw|台湾|台|Taiwan)🕳ℹ️🇸🇬 狮城节点🏷ℹ️^(?!.*(?:us)).*(新加坡|坡|狮城|SG|Singapore)🕳ℹ️🇯🇵 日本节点🏷ℹ️^(?!.*(?:us)).*(🇯🇵|JP|jp|日本|日|Japan)🕳ℹ️🇺🇸 美国节点🏷ℹ️^(?!.*(?:AUS|RUS)).*(🇺🇸|US|us|美国|美|United States)
